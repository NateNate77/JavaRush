    ...
    public static class IncomeDataAdapter implements Customer, Contact{
        ...
        public String getPhoneNumber() {
            ...
            if(numberPhone.length()<10){
                while (10-numberPhone.length()>0){
                    numberPhone = "0" + numberPhone;
                }
            }
            return "+" + this.data.getCountryPhoneCode() + "(" + numberPhone.substring(0,3) + ")" + numberPhone.substring(3,6) + "-" + numberPhone.substring(6,8) + "-" + numberPhone.substring(8);
        }
    }
