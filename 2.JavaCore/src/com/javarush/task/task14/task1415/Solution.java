...
public class Solution {
    ...
    public static void cleanAllApartments(List<Apartment> apartments) {
        ...
        for(Apartment n : apartments){
            if(n instanceof Apt1Room){
                ((Apt1Room) n).clean1Room();
            }
            else if(n instanceof Apt2Room){
                ((Apt2Room) n).clean2Rooms();
            }
            else if(n instanceof Apt3Room){
                ((Apt3Room) n).clean3Rooms();
            }
        }
    }
